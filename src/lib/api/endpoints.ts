export const API_ENDPOINTS = {
  ...
  HOTELS: {
    ...
    UPLOAD_ROOM_IMAGES: (hotelId: string, roomId: string) => `/hotels/${hotelId}/rooms/${roomId}/images/upload`,
  ...
  PAYMENTS: {
    ...
    ADMIN_STATS: '/admin/payments/stats',
    ADMIN_DEBTS: '/admin/payments/debts',
    ADMIN_DRIVER_DEBTS: '/admin/payments/debts/drivers',
    ADMIN_HOTEL_DEBTS: '/admin/payments/debts/hotels',
    ADMIN_DRIVER_DEBT_DETAIL: (debtId: string) => `/admin/payments/debts/drivers/${debtId}`,
    ADMIN_HOTEL_DEBT_DETAIL: (transactionId: string) => `/admin/payments/debts/hotels/${transactionId}`,
    ADMIN_AUDIT_TRAIL: '/admin/wallet/audit-trail',
    ADMIN_ENFORCE_DEBT: '/admin/debts/enforce',
    WITHDRAWAL_ELIGIBILITY: '/wallet/withdrawal/eligibility',
    WITHDRAWAL_INITIATE: '/wallet/withdrawal/initiate',
    WITHDRAWAL_STATUS: (transactionId: string) => `/wallet/withdrawal/${transactionId}/status`,
    ADMIN_WITHDRAWAL_APPROVE: (transactionId: string) => `/admin/wallet/withdrawal/${transactionId}/approve`,
    DRIVER_EARNINGS_SUMMARY: '/driver/earnings/summary',
    HOTEL_MANAGER_EARNINGS_SUMMARY: '/hotel-manager/earnings/summary',
  },
