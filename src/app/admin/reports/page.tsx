            ...
            {isLoading ? (
              <Card className="bg-white/10 backdrop-blur-md">
                <CardContent className="p-12 text-center">
                  <div className="text-white">Loading bookings statistics...</div>
                </CardContent>
              </Card>
            ) : bookingsData ? (
              <div className="space-y-6">
                ...
                {bookingsData.bookings_by_type && (
                  <Card className="bg-white/10 backdrop-blur-md border-white/20">
                    <CardHeader>
                      <CardTitle className="text-white">Bookings by Type</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <SimpleChart
                        type="bar"
        ...
        {activeTab === 'revenue' && (
          ...
          >
            {isLoading ? (
              <Card className="bg-white/10 backdrop-blur-md">
                <CardContent className="p-12 text-center">
                  <div className="text-white">Loading revenue report...</div>
                </CardContent>
              </Card>
            ) : revenueData ? (
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <Card className="bg-white/10 backdrop-blur-md border-white/20">
                    <CardContent className="p-6">
                      ...
                      <div className="text-sm text-gray-300">Platform Commission</div>
                    </CardContent>
                  </Card>
                  <Card className="bg-white/10 backdrop-blur-md border-white/20">
                    <CardContent className="p-6">
                      ...
                      <div className="text-sm text-gray-300">Driver Payouts</div>
                    </CardContent>
                  </Card>
                </div>
        ...
        {activeTab === 'drivers' && (
          ...
          >
            {isLoading ? (
              <Card className="bg-white/10 backdrop-blur-md">
                <CardContent className="p-12 text-center">
                  <div className="text-white">Loading driver performance...</div>
                </CardContent>
              </Card>
            ) : driversData ? (
              <div className="space-y-6">
                <Card className="bg-white/10 backdrop-blur-md border-white/20">
                  <CardHeader>
                    <CardTitle className="text-white">Top 10 Drivers by Earnings</CardTitle>
                  </CardHeader>
                  <CardContent>
