  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8 space-y-12">
        ...
        <section>
          <div className="h-8 w-48 mx-auto mb-8 rounded-full bg-gray-200 animate-pulse" />
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            {Array.from({ length: 5 }).map((_, index) => (
              ...
              >
                <div className="relative w-full max-w-[200px] mx-auto aspect-square rounded-full bg-gray-200 animate-pulse" />
        ...
        <section className="space-y-4">
          <div className="h-7 w-40 rounded-full bg-gray-200 animate-pulse" />
